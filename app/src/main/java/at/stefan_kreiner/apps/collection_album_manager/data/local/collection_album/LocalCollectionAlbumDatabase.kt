...
@Database(
    version = 2,
    entities = [
        LocalCollectionAlbumEntry::class,
        LocalCollectionAlbumItemEntry::class,
    ],
)
abstract class LocalCollectionAlbumDatabase : RoomDatabase() {
    abstract fun localCollectionAlbumDao(): LocalCollectionAlbumEntryDao
    abstract fun localCollectionAlbumItemDao(): LocalCollectionAlbumItemEntryDao
}